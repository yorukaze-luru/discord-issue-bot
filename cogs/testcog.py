...
class TestCog(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        if ctx.invoked_subcommand is None:
            ...
            issuep.add_field(name="**各種リンク**", value="[BOT招待URL](<https://discordapp.com/api/oauth2/authorize?client_id=674176006801850369&permissions=8&scope=bot>)|[サポート鯖](<https://discord.gg/YBRBcmT>)", inline=False)  
